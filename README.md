...
| REST API với Spring Boot: Controller, RequestMapping, `@GetMapping`, `@PostMapping`, `@PutMapping`, `@DeleteMapping` | [View Code](https://github.com/your-repo-link/tree/main/rest-api-basic)           |
